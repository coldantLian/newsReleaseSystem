...
import Modal_add from './simple_page/modal_add_simple';
import Modal_edit from './simple_page/modal_edit_simple';
...
export default class extends Component {
    ...
    handler_getList() {
        ...
        ajax.get(
            ajax.url(ajax.ports.simple_page.list)
        ).then((xhr) => {
    ...
    handler_remove(id) {
        let doRemove = () => {
            ...
            this.setState({ loading: true });
            ajax.post(
                ajax.url(ajax.ports.simple_page.remove),
                { "ids": ids }
            ).then(() => {
                this.handler_getList();
            }).catch((msg) => {
